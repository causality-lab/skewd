...
301818817_Kernel-based_Tests_for_Joint_Independence"
This file is based on https://github.com/strumke/hsic_python.
Parts were adjusted. 
"""
...
def HSIC(x, y):
    ...
    return numpy.trace(
        numpy.matmul(
            centering(gaussian_grammat(x)), centering(gaussian_grammat(y))
        )
    )


def dHSIC(*argv):
    """Calculate HSIC for any dimension d."""
