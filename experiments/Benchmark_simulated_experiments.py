"""Run Benchmark simulated pairs skewd experiments."""

import os
from src.datasets import SIMln, SIMG, SIMc, SIM
...
dataset_types = ["SIM", "SIMc", "SIMG", "SIMln"]
...
if dt == "SIM":
    ...
    raise ValueError("dt needs to be a SIM pairs folder name")
